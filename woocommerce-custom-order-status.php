       ...
       // register_post_status('wc-refunded-progress ', array(
         //   'label' => __('İptal Talep Edildi', 'woocommerce'),
          //  'public' => true,
           ...
           // 'show_in_admin_all_list' => true,
           // 'show_in_admin_status_list' => true,
           // 'label_count' => _n_noop('Kargolandı <span class="count">(%s)</span>', 'İptal Talep Edildi <span class="count">(%s)</span>')
       // ));
        register_post_status('wc-refunded-progress', array(
            ...
            'show_in_admin_all_list' => true,
            'show_in_admin_status_list' => true,
            'label_count' => _n_noop('Kargolandı <span class="count">(%s)</span>', 'İade Talep Edildi <span class="count">(%s)</span>')
        ));
    }

add_action('init', array(new KKEP_Dokan(), 'register_WC_shipped_status'));
add_filter('wc_order_statuses', array(new KKEP_Dokan(), 'add_WC_shipped_status'), 10, 3);
